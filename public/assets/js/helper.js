...
!(function (t, i, e, s) {
  function o(i, e) {
    ...
    return (
      ...
      "top" == n[0] || "bottom" == n[0] || "left" == n[1] || "right" == n[1]
        ? ((h.positionX = n[1]), (h.positionY = n[0]))
        : ((h.positionX = n[0]), (h.positionY = n[1])),
      this.positionX != s && (n[0] = this.positionX.toLowerCase()),
      this.positionY != s && (n[1] = this.positionY.toLowerCase()),
      "left" != this.positionX &&
        "right" != this.positionX &&
        (this.positionX = isNaN(parseInt(this.positionX, 10))
          ? "center"
          : parseInt(this.positionX, 10)),
      "top" != this.positionY &&
        "bottom" != this.positionY &&
        (this.positionY = isNaN(parseInt(this.positionY, 10))
          ? "center"
          : parseInt(this.positionY, 10)),
      (this.position =
        this.positionX +
    ...
    t.extend(o.prototype, {
      ...
      render: function () {
        var t = o.scrollTop,
          ...
          e = t + o.winHeight;
        (this.visibility =
          this.boxOffsetBottom > t && this.boxOffsetTop < e
            ? "visible"
            : "hidden"),
  ...
  j.prototype = {
    ...
    place: function () {
      ...
      this.element.parents().each(function () {
        ...
        "auto" !== b && 0 !== b && i.push(parseInt(b, 10));
      });
      ...
      if (
        ...
        "top" === r
          ? (o += l)
          : (o -= c + parseInt(this.picker.css("padding-top"), 10)),
        this.o.rtl)
      ) {
        var s = e - (n + m);
