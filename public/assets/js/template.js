...
jQuery(document).ready(function () {
  ...
  jQuery.fn.datepicker &&
    jQuery(
      "#main-availability-form, #room-booking-form, #room-information-form"
    )
  ...
  jQuery.fn.magnificPopup &&
    mainImgContainer.magnificPopup({
  ...
  jQuery.fn.magnificPopup &&
    jQuery(".video-url").magnificPopup({
      disableOn: 700,
      type: "iframe",
      mainClass: "mfp-fade",
      removalDelay: 600,
  ...
  jQuery.fn.imagesLoaded &&
    jQuery(".event-main-box, .dishes-main-box").imagesLoaded(function () {
  ...
  jQuery.fn.owlCarousel &&
    jQuery(".owl-carousel", "#testimonials-section").owlCarousel({
      navigation: !0,
      singleItem: !0,
      addClassActive: !0,
      pagination: !1,
  ...
  if (bodyElement.hasClass("booking")) {
    ...
    bookingInlineDatepicker
      .datepicker({
        format: "yyyy-mm-dd",
        autoclose: true,
        startDate: new Date(),
        inputs: jQuery(
          "#booking-date-range-inline .check-in, #booking-date-range-inline .check-out"
        ),
      })
      .on("changeDate", function (e) {
        ...
        mainBookingForm
          .find(".duration")
          .find(".value")
          .text(diffDays >= 1 ? diffDays + " Nights" : diffDays + " Night");
      });
